...
```{r}
# I actually do this part in my second R block.
```
...
```
- "chicago" and "south" are the most common words used overall.
...
```
- There are 5 places whose common words are related to direction.
